...
const AboutUs = () => {
  return (
    <div className="px-[3%] xl:px-[5%] py-4 mx-auto relative z-50 md:mb-20 xl:mb-40 pt-40 md:pt-20" id="about">
      <div className="xl:flex">
        <div className="2xl:w-[50%]">
          <img src={aboutImg} alt="" className=" my-10 xl:mb-0 mx-auto w-[80%]" />
        </div>
        <div className=" mx-4 md:mx-0 xl:w-[50%]">
          ...
          <p className=" xl:w-[90%] 2xl:w-[70%] leading-loose text-center xl:text-left mt-5">
